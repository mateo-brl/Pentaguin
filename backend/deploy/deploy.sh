...
rsync -az -e ssh backend/server.mjs backend/auth.mjs backend/progress.mjs backend/privacy.html backend/support.html backend/deploy/backup.sh backend/admin.mjs "$HOST:$APP_DIR/"
