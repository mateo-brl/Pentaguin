...
export const monetizationConfig: MonetizationConfig = {
  ...
  // L'app est soumise à Apple comme gratuite et SANS achat intégré : la valeur
  // est écrite en dur, et non lue dans l'environnement, pour qu'aucune variable
  // définie côté EAS ne puisse rebrancher les verrous sur un build déjà validé.
  // Le jour de la bascule en payant, remettre
  // `process.env.EXPO_PUBLIC_MONETIZATION !== 'off'` ici.
  enabled: false,
  free: {
