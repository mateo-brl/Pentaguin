...
const fr = {
  ...
  paywall: {
    ...
    oneTimeTitle: 'Un seul achat, accès à vie',
    oneTimeBody: 'Jamais d’abonnement. Tu paies une fois, c’est à toi pour toujours.',
    buy: 'Débloquer',
...
const en: Strings = {
  ...
  paywall: {
    ...
    oneTimeTitle: 'One purchase, lifetime access',
    oneTimeBody: 'Never a subscription. Pay once, it’s yours for good.',
    buy: 'Unlock',
